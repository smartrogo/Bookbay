...
export const Cart = () => {
  ...
  // export const cartAtom = atom(myCartBooks.length)
...
<div className="flex md:justify-center items-center">
          <img
            ...
            <span className="text  font-medium text-[1.125rem] text-style leading-normal">{item.title}</span>
...
{showDeleteModal && (
  ...
  <div>
   <span className="text-red-400">Are you sure you want to delete this book from your cart?</span>
              ...
              <div className="mt-4 flex gap-4">
                ...
                {
                  loading ? <LoadingBtn loading={loading} value="Deleting" cls_name="text-[0.80rem] btn hover:bg-red-600 md:text-[1rem] font-medium bg-red-400 rounded-[0.25rem] md:rounded-[0.3125rem] text-[#FFFFFF] py-[0.5rem] px-[0.5rem] sm:py-[0.5rem] sm:px-[1rem] md:px-[1.25rem] poppins text-center text-style capitalize md:py-[0.625rem] text-center flex items-center px-4 leading-[1.23713rem] md:leading[0.62181rem]"/> : <Button value="Delete" onClick={confirmDelete} cls_name="text-[0.80rem] btn hover:bg-red-600 md:text-[1rem] font-medium bg-red-500 rounded-[0.25rem] md:rounded-[0.3125rem] text-[#FFFFFF] py-[0.5rem] px-[0.5rem] sm:py-[0.5rem] sm:px-[1rem] md:px-[1.25rem] poppins text-center text-style capitalize md:py-[0.625rem] text-center flex items-center px-4 leading-[1.23713rem] md:leading[0.62181rem]"/>
                }
  ...
  return (
    <div style={{paddingTop: isCartEmpty ? "8rem" : "5rem"}} className="h-screen">
      ...
      <h1 className="text-[#000] capitalize font-bold test-style outfit md:text-[3rem] text-[1.5rem] leading-normal">cart management </h1>
      <p className="text-[#1E1E1E] text-[0.875rem] md:text-[1.25rem] text-style font-medium leading-normal">{`You have ${myCartBooks.length} item in your cart`}</p>
