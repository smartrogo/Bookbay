...
export const Forms = () => {
  return (
    <div className='border-2 border-red-500 flex items-center justify-center h-[100vh]'>

    <div className="w-full border-2 border-red-500 max-w-sm p-6 m-auto mx-auto bg-[#fff] rounded-lg shadow-md">

    <div className="flex flex-col text-center leading-normal text-style text-[#000]  border-2 justify-center mx-auto">
    ...
    <div className="flex items-center border-2 justify-between mt-4">
