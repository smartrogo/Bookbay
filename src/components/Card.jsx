...
export const Card = (props) => {
  return (
    ...
    <div className="p-6 mt-4 m">
      ...
      <p className="text-sm pr-2 md:pr-0 poppins w-[16.03069rem] md:w-[17.25rem] lg:w-[17.25rem] relative text-[0.91488rem] md:text-[1rem] italic font-normal leading-[25px] text-center mx-auto text-[#000]">
