...
export const Card = () => {
  return (
    <div className="block mt-10 max-w-[20rem] h-[100%]  rounded-lg border border-success bg-transparent shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:border-success-300 dark:bg-neutral-600">

    <div className="border-b-2 border-success px-6 py-3 text-neutral-600 dark:border-success-300 dark:text-neutral-50 relative">
      <img src={ellipse3} alt="testimony img" className='absolute -top-10 left-[6.2rem] w-[5.25rem] h-[5.25rem] rounded-[8.25rem]' />
    </div>

    <div className="p-6 m">

      <p className="text-sm poppins relative border-2 border-red-500 md:mt-8 text-[0.91488rem] md:text-[1.25rem] italic font-normal leading-normal poppins text-center  mx-auto ">
          <span className="qoute font-bold text-[2.19569rem] absolute left-0 -top-1 md:top-1">
            &#8220;
           </span>
           <br />
