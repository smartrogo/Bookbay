            ...
            <form onSubmit={handleSubmit} >
              ...
              <Button
                ...
                cls_name={
                  ...
                  "bg-[#0F9D58] btn mx-auto w-full rounded-[0.29656rem] md:rounded-[0.5rem] py-[0.37069rem] px-[0.92675rem] md:py-[0.625rem] md:px-[1.5625rem] text-center text-[#fff] poppins text-[0.66725rem] md:text-[1.125rem] text-style leading-normal font-normal capitalize"
                }
              />
          </form>
          <ToastContainer />
