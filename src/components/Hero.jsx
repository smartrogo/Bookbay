    ...
    <div className="flex border-2 h-screen border-red-500 flex-col md:justify-center items-center md:flex-row md:w-[95%] mx-auto">
      <div className="w-full md:w-[50%]">
        <div className="lg:[80%] xl:pl-16">
          <h1 className=" w-[21.1875rem] mx-auto h-[7rem] flex-shrink-0 text-[2.5rem] outfit leading-[3rem] mt-20 font-bold text-center md:text-start md:w[31.9375rem] sm:w-[90%]  balance mb-0">
            Your Ultimate
            <br /> Online
          ...
          <p className="poppins leading-normal text-center text-style font-normal text-[0.875rem] mx-auto w-[17.3125rem] h[6.5625rem] md:w-[90%] lg:w-[65%] lg:mx-7 xl:w-[66%] sm:w-[50%] md:text-justify ">
...
export const Hero = () => {
    ...
    "BookBay: Your one-stop platform for buying, selling, and borrowing books. Discover a vast selection, enjoy great deals, and join our family by signing up today.";
  return (
    <div className="mt-[14%] border-2 mb-10 lg:-[100vh] sm:mt-[13%] md:mt-[9.5%] lg:mt-[8%] xl:mt-[6%]">
        <HeroContent />
    </div>
  );
};
