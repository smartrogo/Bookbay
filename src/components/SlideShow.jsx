  ...
  return (
      <SwiperSlide className=" flex flex-col justify-center items-center md:flex-row">
        <div className="w-full md:w-[50%]">
          <div className="md:[80%]">
            <h1 className=" w-[24.1875rem] mx-auto h-[10.6875rem] flex-shrink-0 text-[2.4rem] roboto leading-[3rem] mt-10 font-bold text-center md:text-start md:w-[76%] sm:w-[90%] md:ml-20 balance">
             {heading}
            </h1>
