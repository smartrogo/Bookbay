...
export const SlideShow = ({ paragrhap, img, heading }) => {
  ...
  return (
      <SwiperSlide className="flex flex-col justify-center items-center md:flex-row md:w-[95%] mx-auto">
        <div className="w-full md:w-[50%]">
          <div className="lg:[80%] xl:pl-16">
            ...
            <p className="poppins leading-normal text-center text-style font-normal text-[0.875rem] mx-auto w-[19.3125rem] h[6.5625rem] md:w-[90%] lg:w-[70%] lg:mx-7 xl:mx- xl:w-[65%] sm:w-[80%] md:text-justify balance">
                {paragrhap}
            </p>
        ...
        <div className="w-full md:w-[50%] px-5 md:px-0 xl:pr-16">
          <img
            src={img}
            className=" w-[22.8125rem] sm:w-[32rem] rounded-[2rem] h-[23.95313rem] mx-auto object-cover mt-10 mb-8  sm:mt-5 md:w-[25.5rem] xl:w-[35.5em] md:h-[27.375rem]"
          />
        </div>
      </SwiperSlide>
  );
