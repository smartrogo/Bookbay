...
export const MiniSwipper = () => {
  ...
  return (
    <>
      ...
      <div className="display border-2 border-red-500 book-container md:w-[95%] mx-auto md:flex justify-evenly">

      <div className="flex w-full border-2 border-red-500 md:w-1/2 justify-evenly">
