  ...
  return (
    <Link to={`/books/${bookId}`} className="w-full h-full">
      <div className="h-[15rem] bd w-full text-center sm:h-[24rem] lg:h-[20rem] xl:h-[20rem] flex flex-col items-center justify-center ">
        ...
        <div className="book flex items-center mb-3 justify-center w-[65%] lg:w-[55%] lg:h-[60%] h-[60%] sm:h-[70%]">
          {loading ? (
        ...
        <span className="color text-xs md:text-sm mx-auto w-full md:w-[70%]">
          {loading ? (
          <Skeleton className="mb-[2px] mt-[8px] ske" baseColor="#D9D9D9" highlightColor="#fcfcfc" />
          ) : (
